const en = {
    translation: {
        ...
        maxVideosUploaded: "You have uploaded the maximum number of allowed videos.",
        sale: "Sale",
        enterSaleAmount: "Enter Sale Amount",
        saleAmount: "Sale Amount",
        buy: "Buy",
        buyAmount: "Buy Amount",
        distanceForMainRoad: "Distance from Main Road (in feet)",
        enterDistanceForMainRoad: "Enter Distance from Main Road (in feet)",
