const en = {
    translation: {
        ...
        switchUserConfirmation: "Are you sure you want to switch user? This will log you out and redirect you to the login screen.",
        ...
        priceDayNight: " /Day",
        singleBedAc: "Single Bed AC",
        singleBedNonAc: "Single Bed Non AC",
        ...
        maxVideosUploaded: "To change the video, remove the current one and re-upload.",
        sale: "Sale",
        enterSaleAmount: "Enter Sale Amount",
        saleAmount: "Sale Amount",
        buy: "Buy",
        buyAmount: "Buy Amount",
        distanceForMainRoadLabel: "Distance from Main Road",
        distanceForMainRoad: "Distance from Main Road (in meter)",
        enterDistanceForMainRoad: "Enter Distance from Main Road (in meter)",
        widthOfTheRoadInFrontOfAPropertyLabel: "Width of Front Road",
        widthOfTheRoadInFrontOfAProperty: "Width of Front Road (in feet)",
        enterWidthOfTheRoadInFrontOfAProperty: "Enter Width of Front Road (in feet)",
        projectMap: "Upload One Project Map",
        municipleBill: "Last Municipal Bill paid for the year",
        tehsilBill: "Last Tehsil Bill paid for the year",
        selectYear: "Select Year",
        uploadOneVideo: "Upload one video",
        otherRoomAvailableMessage: "Would you like to show other available rooms tariff?",
        otherRoomAvailableType: "Other Available Room Tariff",
        ...
        widthProperty: "Width of Property (in feet)",
        enterWidthProperty: "Enter Width of Property (in feet)",
        lengthProperty: "Length of Property (in feet)",
        enterLengthProperty: "Enter Length of Property (in feet)",
